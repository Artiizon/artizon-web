        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div>
                  <Link to="/company-design" className="text-gray-700 mb-4 flex items-center">
                    ...
                    <p className="text-red-400 font-light text-2xl font-sans p-2">DESIGN BY ARTIZON</p>
            ...
            <div className="flex items-center">
                ...
                {product.rating.toFixed(1)} rating based on {product.reviewCount} {product.reviewCount === 1 ? 'review' : 'reviews'}
                </span>
            </div>
            </div>
