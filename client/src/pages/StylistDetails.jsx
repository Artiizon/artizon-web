...
export default function StylistProfile() {
    ...
    const stylistId = sessionStorage.stylist_id;
    ...
    useEffect(() => {
        axios.post('http://localhost:8080/getStylistDetails', { stylistId: stylistId })
            .then(res => {
                setStylist(res.data);
            })
    }, []);
    ...
    <div className="font-sans mt-[-50px] min-h-[625.5px]">
      <div className="flex flex-col text-center">
        ...
        <p className="text-[35px]  ml-[165px] mt-[20px] mb-[15px] font-bold uppercase">
            {stylist.title}. {stylist.first_name} {stylist.last_name}
        </p>
        ))}
      </div>
      ...
      <div className="ml-[110px]">
        <div className="orders ml-[300px] mt-[10px] mb-[5px] flex">
          ...
          {stylist.map((stylist) => (
          <p className=" text-l ml-[300px]">{stylist.first_name} {stylist.last_name}</p>
          ))}
        </div>
        ...
        <div className="orders ml-[300px] mt-[10px] mb-[5px] flex">
          ...
          {stylist.map((stylist) => (
          <p className=" text-l ml-[300px]">{stylist.email}</p>
          ))}
        </div>
        <hr width="50%" className="ml-[300px]" />
        <div className="orders ml-[300px] mt-[10px] mb-[5px] flex">
          ...
          {stylist.map((stylist) => (
          <p className=" text-l ml-[300px]">{stylist.contact_number}</p>
          ))}
        </div>
        <hr width="50%" className="ml-[300px]" />
        {/* <div className="orders ml-[300px] mt-[10px] mb-[5px] flex">
