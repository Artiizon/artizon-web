      ...
      <div className=" ml-[-23px] gap-2 ">
        ...
        {filteredData.map((item) => (
          ...
          >
            ...
            <div className="w-[80px] pl-2 ml-[50px] text-center">{item.orders}</div>
            <NavLink to="/customerPortfolia"><button className=" w-[100px] h-[25px] mt-[3px] bg-black rounded-md text-white text-sm ml-[180px]">
              More
            </button>
            </NavLink>
          </div>
