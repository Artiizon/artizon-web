  ...
  return (
    <div>
      <div className="ml-[240px]">
        ...
        <div className="flex">
          <label className="p-2 w-[130px] h-[40px] ">Add Designs</label>
          <input
            type="text"
            className="w-[380px] h-[100px] mb-[10px] mt-[5px] px-2 py-1 bg-[#EFEFEF] border border-gray-300 rounded-md focus:ring focus:ring-blue-200 focus:border-blue-400 focus:outline-none"
          />
        </div>
      </div>
