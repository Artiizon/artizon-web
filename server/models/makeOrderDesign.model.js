...
router.route('/').post((req, res) => {
    ...
    const sql1 = 'INSERT INTO `tshirt_order` (`tmaterial`, `tcolor`, `additional_note`,  `expected_days`, `status`, `customer_id`, `company_design_id`) VALUES (?);';

    const VALUES1 = [req.body.material, req.body.color, req.body.note, req.body.days, 'Pending', req.body.customerId, req.body.id];
